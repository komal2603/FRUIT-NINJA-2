...
function enemy(){
 ...
 enemy.addAnimation("enemy_blinking",enemyImage)
  ...
  if(position===1){enemy.x = 0
                  enemy.velocityX = 7} else {enemy.x = 600}
  enemyG.add(enemy)
...
function fruit1(){
  ...
  fruit1.lifetime=150
  position = Math.round(random(1,2))
  if(position===1){fruit1.x = 0
                  fruit1.velocityX = 7} else {fruit1.x = 600}
  fruitG.add(fruit1)
...
function fruit2(){
  ...
  fruit2.lifetime=150
  position = Math.round(random(1,2))
  if(position===1){fruit2.x = 0
                  fruit2.velocityX = 7} else {fruit2.x = 600}
  fruitG.add(fruit2)
  }
...
function fruit3(){
  ...
  fruit3.lifetime=150
  position = Math.round(random(1,2))
  if(position===1){fruit3.x = 0
                  fruit3.velocityX = 7} else {fruit3.x = 600}
  fruitG.add(fruit3)
  }
...
function fruit4(){
  ...
  fruit4.lifetime=150
  position = Math.round(random(1,2))
  if(position===1){fruit4.x = 0
                  fruit4.velocityX = 7} else {fruit4.x = 600}
  fruitG.add(fruit4)
  }
